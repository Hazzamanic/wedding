...
{
    [Authorize]
    public class SaveTheDateModel : PageModel
    {
        private readonly ILogger<SaveTheDateModel> _logger;
        private readonly UserManager<User> UserManager;
        private readonly ApplicationDbContext _db;

        public SaveTheDateModel(ILogger<SaveTheDateModel> logger, UserManager<User> userManager, ApplicationDbContext db)
        {
            _logger = logger;
